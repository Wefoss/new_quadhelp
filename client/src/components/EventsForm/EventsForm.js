...
const EventsForm = (props) => {
  ...
  return (
    <Formik
      ...
      initialValues={eventsValues}
      onSubmit={props.submitFormEvents}
      validationSchema={validationSchema.EventsValidate}
    >
      <Form className={styles.progressBar_form}>
        <Field
          className={styles.text_content}
          type="text"
          name="title"
          placeholder="write a new feafure"
          as={InputEvents}
        />
